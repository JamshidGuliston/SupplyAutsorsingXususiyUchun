...
<body>
    ...
    <!-- Buurtmachi ma'lumotlari (markazda) -->
    <div class="company-info">
        <div class="section-title">Буюртмачи:</div>
        <div class="company-details font-bold">{{ $buyurtmachi['company_name'] ?? '_________________________________' }}</div>
    ...
    <!-- Footer qismi -->
    <div class="footer">
        <div class="signature-label font-bold">Қабул қилди:</div>
        <br/>
        <div class="signature-label font-bold">{{ $buyurtmachi['company_name'] ?? '' }}</div>
        <br/>
        <div class="signature-label">директори: ___________      ______________________</div>
        <br/>
